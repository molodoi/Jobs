<?php
namespace Ticme\Jobs\Controller\Adminhtml\Job;
...
{
    /*
     * La constante ADMIN_RESSOURCE est très importante car elle permet de vérifier 
     * si nous avons accès à ce contenu de l’admin (ACL).
     * Dans notre acl.xml c'est l’id de la première ligne 
     */
    const ADMIN_RESOURCE = 'Ticme_Jobs::job';
    ...
    {        
        ...
        $resultPage->setActiveMenu('Ticme_Jobs::job');
        /*
        ...
        */
        ...
        /* ->prepend, permet de précéder le titre de la page par « Job », de ce fait, le title de notre page est « Job / Jobs / Magento Admin » */
